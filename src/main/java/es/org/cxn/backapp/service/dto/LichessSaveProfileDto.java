 ...
 *
 */
public record LichessSaveProfileDto(String userEmail, String identifier, String username, LocalDateTime updatedAt,
     ...
     */
    public record SaveGameStatistics(Integer games, Integer rating, Integer ratingDerivation, Integer prog,
            Boolean prov) {
    }
}
