 ...
 * {@code es.org.cxn.backapp.controller} package. It captures and logs
 * method names, parameters, return values, and exceptions.
 * </p>
 *
 * @author Santiago Paz
 */
...
public class ControllerLoggingAspect {
   ...
   * <p>
   * This advice is executed before any method in the
   * {@code es.org.cxn.backapp.controller} package. It logs the name of the
   * method being called and its arguments.
   * </p>
   *
   ...
   * {@code es.org.cxn.backapp.controller} package returns successfully.
   * It logs the name of the method and the return value, if any.
   * </p>
   *
   * @param joinPoint the join point providing reflective access to the method
   *                  being executed
  ...
  public void
        logAfterReturning(final JoinPoint joinPoint, final Object result) {
    if (LOGGER.isInfoEnabled()) {
      final var methodName = getMethodName(joinPoint);
      LOGGER.info(
            "Exiting method: {} with return value: {}", methodName, result
      );
    }
  }
  ...
  public void
        logAfterThrowing(final JoinPoint joinPoint, final Throwable error) {
