 ...
 * @author Santiago Paz
 */
public record InvoiceResponse(BigInteger number, String series, LocalDate advancePaymentDate, LocalDate expeditionDate,
        Boolean taxExempt, String sellerNif, String buyerNif) {

    /**
     * Creates an {@link InvoiceResponse} from an {@link InvoiceEntity}.
     * <p>
     * This static factory method initializes a new {@code InvoiceResponse} using
     * the data from the provided {@code InvoiceEntity}.
     * </p>
     *
    ...
    public static InvoiceResponse fromEntity(final InvoiceEntity entity) {
        return new InvoiceResponse(BigInteger.valueOf(entity.getNumber()), entity.getSeries(),
                entity.getAdvancePaymentDate(), entity.getExpeditionDate(), entity.isTaxExempt(),
                entity.getSeller().getNif(), entity.getBuyer().getNif());
    }
}
