 ...
 * event. This interface provides methods to access and modify information
 * related to the payment sheet, including its identifier, reason, place, dates,
...
public interface PaymentSheetEntity extends Serializable {
     ...
     *
     * @return The end date of the payment sheet event, or {@code null} if not set.
     */
     ...
     *
     * @return The start date of the payment sheet event, or {@code null} if not
     *         set.
     */
     ...
     *
     * @return The user entity that owns the payment sheet, or {@code null} if not
     *         set.
     */
     ...
     *
     * @param value A set of regular transport entities to be associated with this
     *              payment sheet.
     */
