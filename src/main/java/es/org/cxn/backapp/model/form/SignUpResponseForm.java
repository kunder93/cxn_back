...
public class SignUpResponseForm implements Serializable {
     ...
     */
    public SignUpResponseForm(final String nameValue,
    ...
    public final void setFirstSurname(final String value) {
        this.firstSurname = checkNotNull(value,
                "Received a null pointer as first surname");
    }
    ...
    public final void setSecondSurname(final String value) {
        this.secondSurname = checkNotNull(value,
                "Received a null pointer as second surname");
    }
    ...
    public final void setBirthDate(final LocalDate value) {
        this.birthDate = checkNotNull(value,
                "Received a null pointer as birthDate");
    }
